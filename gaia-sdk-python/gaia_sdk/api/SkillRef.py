...
class SkillRef:
    ...
    def evaluate(self, payload: dict, timeout_in_millis: int = 300000, contract: str = None) -> Observable[SkillEvaluation]:
        request = {'uri': self._uri, 'payload': payload, 'timeout': timeout_in_millis}
