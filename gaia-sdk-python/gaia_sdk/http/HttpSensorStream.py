...
class HttpSensorStream(ISensorStream):
    ...
    def __init__(self, url: str, credentials, client_factory: GaiaStreamClientFactory):
        self.client = client_factory.http(url + "/api").with_credentials(credentials).build()
