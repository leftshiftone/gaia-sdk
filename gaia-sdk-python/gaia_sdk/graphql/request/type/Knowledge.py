...
class Knowledge(list):
    ...
    def identities(self, limit: int, offset: int, config: Callable[['Identity'], None]):
        def callback(registry: VariableRegistry):
            name1 = registry.register("limit", limit)
            name2 = registry.register("offset", offset)
            entity = Identity()
            config(entity)
            return f'identities(limit:{name1}, offset:{name2})' + '{' + entity.render(registry) + '}'
    ...
    def intents(self, identityId: str, limit: int, offset: int, config: Callable[['Intent'], None]):
        def callback(registry: VariableRegistry):
            name1 = registry.register("identityId", identityId)
            ...
            entity = Intent()
            config(entity)
            return f'intents(identityId:{name1}, limit:{name2}, offset:{name3})' + '{' + entity.render(registry) + '}'
        self.append(callback)
    ...
    def prompts(self, identityId: str, limit: int, offset: int, config: Callable[['Prompt'], None]):
        def callback(registry: VariableRegistry):
            name1 = registry.register("identityId", identityId)
            name2 = registry.register("limit", limit)
            name3 = registry.register("offset", offset)
            entity = Prompt()
            config(entity)
            return f'prompts(identityId:{name1}, limit:{name2}, offset:{name3})' + '{' + entity.render(registry) + '}'
        self.append(callback)
    ...
    def fulfilments(self, identityId: str, limit: int, offset: int, config: Callable[['Fulfilment'], None]):
        def callback(registry: VariableRegistry):
            name1 = registry.register("identityId", identityId)
            name2 = registry.register("limit", limit)
            name3 = registry.register("offset", offset)
            entity = Fulfilment()
            config(entity)
            return f'fulfilments(identityId:{name1}, limit:{name2}, offset:{name3})' + '{' + entity.render(registry) + '}'
        self.append(callback)
    ...
    def statements(self, identityId: str, limit: int, offset: int, config: Callable[['Statement'], None]):
        def callback(registry: VariableRegistry):
            name1 = registry.register("identityId", identityId)
            name2 = registry.register("limit", limit)
            name3 = registry.register("offset", offset)
            entity = Statement()
            config(entity)
            return f'statements(identityId:{name1}, limit:{name2}, offset:{name3})' + '{' + entity.render(registry) + '}'
        self.append(callback)
    ...
    def codes(self, identityId: str, limit: int, offset: int, config: Callable[['Code'], None]):
        def callback(registry: VariableRegistry):
            name1 = registry.register("identityId", identityId)
            name2 = registry.register("limit", limit)
            name3 = registry.register("offset", offset)
            entity = Code()
            config(entity)
            return f'codes(identityId:{name1}, limit:{name2}, offset:{name3})' + '{' + entity.render(registry) + '}'
        self.append(callback)
    ...
    def behaviours(self, identityId: str, limit: int, offset: int, config: Callable[['Behaviour'], None]):
        def callback(registry: VariableRegistry):
            name1 = registry.register("identityId", identityId)
            name2 = registry.register("limit", limit)
            name3 = registry.register("offset", offset)
            entity = Behaviour()
            config(entity)
            return f'behaviours(identityId:{name1}, limit:{name2}, offset:{name3})' + '{' + entity.render(registry) + '}'
        self.append(callback)
    ...
    def edges(self, source: str, limit: int, offset: int, config: Callable[['Edge'], None]):
        def callback(registry: VariableRegistry):
            ...
            entity = Edge()
            config(entity)
            return f'edges(source:{name1}, limit:{name2}, offset:{name3})' + '{' + entity.render(registry) + '}'
        self.append(callback)
