...
class UpdateSkillProvisionImpulse():
    ...
    def __init__(self, tenantId: str, reference: str, qualifier: str, appendent: str, labelList: List[str], version: str, skillRef: str, initialCpu: int, maximalCpu: int, initialMemory: int, maximalMemory: int, replicas: int, enabled: bool, bootstrapTimeout: int, environment: dict):
