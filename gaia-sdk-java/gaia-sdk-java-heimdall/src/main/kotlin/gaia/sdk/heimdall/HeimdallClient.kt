...
class HeimdallClient(private val options: ClientOptions, private val transporter: ITransporter) {
    ...
    fun <T:HeimdallResponse>executeNative(statement: String, variables:Map<String, Any>, preprocessors: List<String>, type:KClass<T>): Publisher<T> {
