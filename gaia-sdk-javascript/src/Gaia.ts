...
export class GaiaRef implements ISensorFunction, ISensorStream {
    ...
    public retrieveIdentityMetrics = (identityId: Uuid, startDate: string, config: (x: IdentityMetricsReq) => void) => this.fProc.retrieveIdentityMetrics(identityId, startDate, config);
